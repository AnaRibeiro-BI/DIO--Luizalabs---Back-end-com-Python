...
# Entrada: A primeira linha contém o nome do remetente. A segunda linha contém o conteúdo da mensagem, ambos sem acentos ou caracteres especiais.
# O comprimento de cada linha está limitado ao máximo de 69 caracteres ASCII.
# Saída: Imprima uma única linha no formato ": ", respeitando exatamente este padrão.
# A saída não deve conter espaços extras, aspas ou acentos e deve exibir apenas a mensagem processada pelo objeto criado.
# Exemplos: A tabela abaixo apresenta exemplos de entrada e saída:
# Entrada Saída
# Maria
# Bom dia equipe Maria: Bom dia equipe
# Joao
# Reuniao adiada para amanha Joao: Reuniao adiada para amanha
# Luiz23
# Teste do sistema completo Luiz23: Teste do sistema completo

# class Mensagem: def init(self, remetente, conteudo): # Inicializa os atributos da mensagem
