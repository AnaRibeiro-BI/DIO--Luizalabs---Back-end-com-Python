...
# Entrada: Uma linha contendo duas strings separadas por espaço, representando os modelos do robô (apenas caracteres ASCII sem acentuação, mínimo 1 e máximo 30 cada).
# Saída: Uma única linha contendo o nome completo do robô, no formato modelo1-modelo2 (sem espaços adicionais e sem acentuação), tudo em uma string.
...
# class Robo:
# def init(self, modelo1: str, modelo2: str):
...
if len(modelos) != 2:
    ...
    # Cria um objeto da classe Robo com os modelos e imprime o nome completo
